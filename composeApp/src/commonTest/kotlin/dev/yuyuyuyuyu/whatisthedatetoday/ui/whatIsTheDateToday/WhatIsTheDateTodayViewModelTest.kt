...
class WhatIsTheDateTodayViewModelTest {
    ...
    fun `ViewModel should initialize uiState correctly`() = runTest {
        ...
        // Arrange
        val repository = CurrentDateRepositoryImpl(
            currentDateDataSource = FakeCurrentDateDataSource(),
        )

        // Act
        val viewModel = WhatIsTheDateTodayViewModelImpl(
            currentDateRepository = repository,
        )
        ...
        val expected = WhatIsTheDateTodayUiState(
